...
#ifndef CepstrumDemoH
#define CepstrumDemoH
//---------------------------------------------------------------------------
#include <Classes.hpp>
...
#include <ToolWin.hpp>
//---------------------------------------------------------------------------
class TCepstrumDemoForm : public TForm
{
__published:	// IDE-managed Components
	...
	void __fastcall CepstrumBoxChange(TObject *Sender);
	...
	void __fastcall SpectrumAnalyzer1AfterUpdate(TObject *Sender);
private:	// User declarations
	Mtxexpr::sVector Data;
public:		// User declarations
	__fastcall TCepstrumDemoForm(TComponent* Owner);
};
//---------------------------------------------------------------------------
extern PACKAGE TCepstrumDemoForm *CepstrumDemoForm;
//---------------------------------------------------------------------------
#endif
