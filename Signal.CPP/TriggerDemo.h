...
//---------------------------------------------------------------------------
class TTriggerDemoForm : public TForm
{
__published:	// IDE-managed Components
	...
	TMtxFloatEdit *AboveEdit;
	TComboBox *PositionEdit;
	TPanel *Panel2;
	TSplitter *Splitter1;
...
public:		// User declarations
	__fastcall TTriggerDemoForm(TComponent* Owner);
};
//---------------------------------------------------------------------------
extern PACKAGE TTriggerDemoForm *TriggerDemoForm;
//---------------------------------------------------------------------------
#endif
