...
#ifndef PeakMarkingBasicH
#define PeakMarkingBasicH
//---------------------------------------------------------------------------
#include <Classes.hpp>
...
//---------------------------------------------------------------------------
class TPeakMarkingBasicForm : public TForm
{
...
public:		// User declarations
	__fastcall TPeakMarkingBasicForm(TComponent* Owner);
};
//---------------------------------------------------------------------------
extern PACKAGE TPeakMarkingBasicForm *PeakMarkingBasicForm;
//---------------------------------------------------------------------------
#endif
