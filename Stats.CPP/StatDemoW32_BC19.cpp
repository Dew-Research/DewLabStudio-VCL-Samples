...
int WINAPI _tWinMain(HINSTANCE, HINSTANCE, LPTSTR, int)
{
	try
	{
		...
		Application->CreateForm(__classid(TfrmBasicQC), &frmBasicQC);
		Application->CreateForm(__classid(TfrmQCXR), &frmQCXR);
		Application->CreateForm(__classid(TfrmQCAttr), &frmQCAttr);
		Application->Run();
	}
