...
Uses Optimization, MtxVecTee, Math387, MtxVecEdit, LogMemo, MtxVec,
  MtxIntDiff, AbstractMtxVec, Types;
...
function MGH09(const B: TVec; X: double): double;
begin
...
begin
  ...
  begin
    MtxNonLinReg.X.Size(16, MtxNonLinReg.X.FloatPrecision); //preserve existing precision
  ...
  begin
      MtxNonLinReg.X.Size(15, MtxNonLinReg.X.FloatPrecision); //preserve existing
...
procedure TfrmNonLinTest.WriteToLog(Elapsed: double);
var i: Integer;
    tmpStr: String;
begin
  case ComboBox2.ItemIndex of
